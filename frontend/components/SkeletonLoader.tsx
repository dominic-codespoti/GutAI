...
function SkeletonBlock({ width, height, style }: { width: number | string; height: number; style?: any }) {
  ...
  return (
    <Animated.View
      style={[
        { width: width as any, height, backgroundColor: '#e2e8f0', borderRadius: 6, opacity },
        style,
      ]}
    />
  );
...
export function CardSkeleton() {
  return (
    <View style={{ backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 8 }}>
...
export function DashboardSkeleton() {
  return (
    <View style={{ padding: 20 }}>
      ...
      <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 20, marginTop: 20 }}>
        <SkeletonBlock width={120} height={16} />
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 }}>
          <SkeletonBlock width={80} height={36} />
          <SkeletonBlock width={60} height={20} />
        </View>
        <SkeletonBlock width="100%" height={8} style={{ marginTop: 12, borderRadius: 4 }} />
      </View>
      <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 20, marginTop: 12 }}>
        <SkeletonBlock width={80} height={16} />
  ...
  return (
    <>
      {[1, 2, 3].map((i) => (
        <View
          key={i}
          style={{ backgroundColor: '#fff', borderRadius: 10, padding: 14, marginBottom: 6, flexDirection: 'row', alignItems: 'center' }}
        >
...
export function InsightsSkeleton() {
  return (
    <View>
      {[1, 2, 3].map((i) => (
        <View key={i} style={{ backgroundColor: '#fff', borderRadius: 8, padding: 12, marginBottom: 4 }}>
  ...
  return (
    <View style={{ padding: 20 }}>
      <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 20, alignItems: 'center' }}>
        <SkeletonBlock width={72} height={72} style={{ borderRadius: 36, marginBottom: 12 }} />
