...
public class FodmapService
{
    ...
    [
        ...
        ("mango", null, new() { Name = "Mango (Excess Fructose)", Category = "Monosaccharide", SubCategory = "Excess Fructose", Severity = "Moderate",
    ...
    [
        ...
        ("soy milk", new() { Name = "Soy Milk (GOS)", Category = "Oligosaccharide", SubCategory = "GOS", Severity = "Moderate",
        ...
        ("cherries", new() { Name = "Cherries (Fructose + Sorbitol)", Category = "Monosaccharide + Polyol", SubCategory = "Excess Fructose + Sorbitol", Severity = "High",
            Explanation = "Cherries are high in both excess fructose and sorbitol." }),
        ("blackberry", new() { Name = "Blackberry (Fructose + Polyol)", Category = "Monosaccharide + Polyol", SubCategory = "Excess Fructose + Sorbitol", Severity = "Moderate",
            Explanation = "Blackberries contain moderate excess fructose and polyols." }),
        ("blackberries", new() { Name = "Blackberries (Fructose + Polyol)", Category = "Monosaccharide + Polyol", SubCategory = "Excess Fructose + Sorbitol", Severity = "Moderate",
            Explanation = "Blackberries contain moderate excess fructose and polyols." }),
